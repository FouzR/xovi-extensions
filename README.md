...
5.1 Long swipe up/down changes thickness
5.2 Short swipe up/down changes colour depending on the config
5.3 Diagonal swipe up from the middle of the edge swaps between Eraser tool and pen
5.4 Diagonal swipe down from the middle of the edge swaps between Selection tool and pen
